...
def to_mod_list(employee_list):
   ...
   list_mod= map(mod,employee_list)
   return list(list_mod)
...
def generate_usernames(mod_list):
   ...
   """
   ### WRITE SOLUTION CODE HERE
   comp_list = [i.replace(' ','_') for i in mod_list]
   return comp_list
   raise NotImplementedError()
...
def map_id_to_initial(employee_list):
   ...
   """
   ### WRITE SOLUTION CODE HERE
   comp_dictionary ={employee['name'][0]:employee['id']for employee in employee_list}
